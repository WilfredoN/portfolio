...
export const ExperienceCard = ({
  ...
  return (
    ...
    >
      <div className='flex flex-wrap items-start justify-between gap-3 text-left'>
        <div className='flex items-center gap-3.5 text-left'>
          {experience.companyLogoUrl && (
            <div className='flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-lg border border-zinc-700 bg-zinc-800 p-1 shadow-sm'>
              <img
          ...
          <div className='flex flex-col items-start gap-1 text-left'>
            <div className='flex items-center gap-3'>
              ...
              {isPresent && (
                <span className='rounded-full border border-emerald-500/60 bg-emerald-500/20 px-2.5 py-0.5 text-xs font-semibold tracking-wider text-emerald-300 uppercase'>
                  Current
                </span>
              )}
            </div>
            ...
            <p
              className={clsx(
                ...
                isHovered ? 'text-zinc-200' : 'text-zinc-300'
              )}
            >
        ...
        <div className='flex flex-wrap items-center gap-2 text-sm'>
          <span className='rounded-md border border-zinc-700 bg-zinc-800 px-2.5 py-1 font-medium text-white'>
      ...
      <ul
        className={clsx(
          'mt-4 flex flex-col gap-2.5 border-t border-zinc-800 pt-4 text-left text-base leading-relaxed transition-colors duration-200',
