...
export const ConstructionButton = ({ children }: ConstructionButtonProps) => {
  ...
  const springY = useSpring(controlY, {
    damping: 7,
    mass: 0.35,
    stiffness: 160
  })

  const pathD = useTransform(springY, (cy) => `M 0 34 Q 75 ${20 + cy} 150 6`)
